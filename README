...
Para representar lo solicitado, se utilizó la estructura de `ListaAdyacenciaGrafo` implementada en el Proyecto 1, la explicacion de su funcionamiento se encuentra en el README de el repositorio correspondiente a la misma.
